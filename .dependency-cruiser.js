...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      comment: "The renderer and the Electron entry point are isolated edges; neither may reach into the other.",
      severity: "error",
    ...
    },
    {
      ...
      comment: "The Electron entry point must not reach into the renderer; renderer concerns are loaded via files, not imports.",
      severity: "error",
      from: { path: "^src/main" },
