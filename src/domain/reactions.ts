...
export const POOLS: Record<string, Reaction[]> = {
  ...
  "idle-long": [
    ...
    { text: "Am I a ghost now?", durationMs: 3500 },
    { text: "I'm bored. Extremely.", durationMs: 4000 },
  ],
  "app-shutdown": [
  ...
  screenshot: [
    ...
    { text: "Say cheese!", durationMs: 2500 },
  ],
  pet: [
    ...
    { text: "Again again!", durationMs: 2500 },
  ],
  "mischief-random": [
    { text: "Hehe.", durationMs: 3000 },
    ...
    { text: "I hid your cursor.", durationMs: 3500 },
    { text: "Did you see that? No?", durationMs: 3500 },
    { text: "I touched the power button… jk!", durationMs: 4000 },
    { text: "Your tabs are fine. Probably.", durationMs: 4000 },
  ],
...
const WEIGHTS: Record<string, number[]> = {
  ...
  "on-ac": [3, 2, 1],
  "on-battery": [3, 2, 1],
  "activity-burst": [4, 2, 2, 1, 1, 1, 1],
  "idle-long": [3, 2, 1, 1, 1, 1],
  "app-shutdown": [3, 2, 1],
  "time-morning": [3, 2, 1],
  "time-lunch": [3, 2, 1],
  "time-evening": [3, 2, 1],
  "time-night": [3, 2, 1],
  "clipboard-copy": [3, 2, 1, 1, 1],
  screenshot: [3, 2, 1, 1],
  pet: [4, 3, 2, 1, 1, 1, 1],
  "mischief-random": [3, 2, 1, 1, 1, 1, 1, 1, 1, 1],
  "ide-save": [3, 2, 1, 1],
  "git-commit": [3, 2, 1, 1],
  "build-green": [3, 2, 1, 1],
  hydrate: [3, 2, 1],
