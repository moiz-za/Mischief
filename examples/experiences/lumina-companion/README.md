...
- `happy`: Prism flare celebration burst
- `sad`: Dimming crystal glow
- `sleep`: Folded crystal nest sleeping mode
- `yawn`: Sparkle wing stretch & yawn
